	...
	public class GuiElement
	{
		...
		public virtual bool MouseClick(MouseState mouseState)
		{
			...
			if (mouseIn)
			{
				...
				{
					MouseEvent?.Invoke(this, new GuiMouseEventArg(MouseBehaviour.MOUSE_GET_IN, mouseState));
				}
				else
				{
					MouseEvent?.Invoke(this, new GuiMouseEventArg(MouseBehaviour.MOUSE_IN, mouseState));
				}
			}
			else
			{
				...
				if (_prevMouseIn != mouseIn)
				{
					MouseEvent?.Invoke(this, new GuiMouseEventArg(MouseBehaviour.MOUSE_GET_OUT, mouseState));
				}
			}
		...
		public delegate void MouseEventHandler(GuiElement sender, GuiMouseEventArg arg);
