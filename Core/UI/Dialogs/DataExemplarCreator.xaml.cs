...
namespace Core.UI.Dialogs {
	/// <summary>
	/// Logique d'interaction pour DataExemplarCreator.xaml
	/// </summary>
	public partial class DataExemplarCreator : UserControl {
		...
		/// <param name="t">The DataEmplar Type we wahnt to create.</param>
		/// </summary>
		...
		public IEnumerable<IDataExemplaire> GetExemplars() {
			...
			w.Title = "Exemplar List";
			_window = w;
			w.ShowDialog();//show the window and returns here whent it's closed.
