...
namespace Core.UI {
		...
		protected virtual UIElement AddProperty( PropertyInfo prop ) {
			...
			if(typeof(IEnumerable).IsAssignableFrom(prop.PropertyType)
				...
				if(typeof(DataModel).IsAssignableFrom(tempType)) {
					...
					liste.Orientation = Orientation.Vertical;
	...
	///// <summary>
	///// Une fiche, mais capable de gérer les IDataObject, car possède une référence à la database.
	///// </summary>
	//public class ReferencesFiche : Fiche {
	//	public Database Database { get; set; }
	//	public ReferencesFiche(Database data) {
	//		Database = data;
 //       }

	//	protected override UIElement AddProperty( PropertyInfo prop ) {
	//		return base.AddProperty(prop);
	//	}
	//}
}
