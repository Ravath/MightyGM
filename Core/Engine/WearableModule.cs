...
namespace Core.Engine {
	...
	public class WearableModule<O,P> where O :IWearable where P : IAgent {

		#region Members
		private ListeWearable<O,P> _inventory;
		private ListeObjets<O,P> _equiped;
		#endregion
		...
		public WearableModule(P perso) {
			_inventory = new ListeWearable<O, P>(perso);
