#
# Check the excel file using dll of the given RPG name.
#
...
if [ -z $1 ] ; then 
	echo "Must have first argument : the path to the Excel file to check"
	exit
fi
if [ ! -f $1 ] ; then 
...
# CALL EXECUTABLE
$TOOLS_EXE excel check "$CURRENT_RPG_DLL" "$1"